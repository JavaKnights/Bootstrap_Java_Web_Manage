									...
									.omResizable(
											{
												...
												resize : function(n, g) {
													...
													var k = a(this), o = k
															...
															b.tbody), p = b.thead
															.closest(".hDiv");
													k.width(n.size.width)
															.height("");
													h.width(n.size.width)
															.height("");
													e
															.height(d.height()
																	- (c
												...
												stop : function(n, m) {
													var l = b.options._onResizableStopCallbacks, k = a(
...
(function(b) {
	b.omWidget
			.addInitListener(
					...
					function() {
						...
						if (c != -1) {
							h.find('th[axis="col' + c + '"] >div').css("width",
									"-=" + f)
						} else {
							if (e.autoFit) {
								var g = f / i;
	...
	function a() {
		...
		var e = d.width() - d.find("th.expenderCol").outerWidth()
				- parseInt(f.find("> td").css("border-right-width"));
		f.each(function() {
